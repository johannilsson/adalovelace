...
(function() {
  var AbstractInterpolator, CubicInterpolator, Enum, LinearInterpolator, NearestInterpolator, PI, SincFilterInterpolator, Smooth, clipClamp, clipMirror, clipPeriodic, defaultConfig, getColumn, getType, isValidNumber, k, makeLanczosWindow, makeScaledFunction, makeSincKernel, normalizeScaleTo, shallowCopy, sin, sinc, v, validateNumber, validateVector, _ref, _ref1,
  ...
  */
  ...
  NearestInterpolator = (function(_super) {
    ...
    function NearestInterpolator() {
      _ref = NearestInterpolator.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  LinearInterpolator = (function(_super) {
    ...
    function LinearInterpolator() {
      _ref1 = LinearInterpolator.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  SincFilterInterpolator = (function(_super) {
    ...
    SincFilterInterpolator.prototype.interpolate = function(t) {
      var k, n, sum, _i, _ref2, _ref3;

      k = Math.floor(t);
      sum = 0;
      for (n = _i = _ref2 = k - this.a + 1, _ref3 = k + this.a; _ref2 <= _ref3 ? _i <= _ref3 : _i >= _ref3; n = _ref2 <= _ref3 ? ++_i : --_i) {
  ...
  Smooth = function(arr, config) {
    var baseDomainEnd, dimension, i, interpolator, interpolatorClass, interpolators, k, n, properties, smoothFunc, v, _ref2, _ref3, _ref4;
    ...
    if ((_ref2 = config.scaleTo) == null) {
      config.scaleTo = config.period;
    }
    if ((_ref3 = config.sincFilterSize) == null) {
      config.sincFilterSize = config.lanczosFilterSize;
    }
    for (k in defaultConfig) {
      if (!__hasProp.call(defaultConfig, k)) continue;
      v = defaultConfig[k];
      if ((_ref4 = config[k]) == null) {
        config[k] = v;
      }
    }
